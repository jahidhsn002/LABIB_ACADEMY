...
abstract class hub_AdminPageFramework_TaxonomyField_Router extends hub_AdminPageFramework_Factory {
...
abstract class hub_AdminPageFramework_TaxonomyField_Model extends hub_AdminPageFramework_TaxonomyField_Router {
...
abstract class hub_AdminPageFramework_TaxonomyField_View extends hub_AdminPageFramework_TaxonomyField_Model {
...
abstract class hub_AdminPageFramework_TaxonomyField_Controller extends hub_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class hub_AdminPageFramework_TaxonomyField extends hub_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'localhost.com') {
